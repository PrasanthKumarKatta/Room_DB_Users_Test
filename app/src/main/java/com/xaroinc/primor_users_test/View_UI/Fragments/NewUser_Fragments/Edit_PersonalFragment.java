...
public class Edit_PersonalFragment extends Fragment {
    ...
    private void setGenderValueToRadioButton(String gender_bundle)
    {
        if (gender_bundle.equals("male")){
            radio_b = rg.findViewById(R.id.rb_male);
            radio_b.setChecked(true);
        }else if(gender_bundle.equals("female")){
            radio_b = rg.findViewById(R.id.rb_female);
            radio_b.setChecked(true);
